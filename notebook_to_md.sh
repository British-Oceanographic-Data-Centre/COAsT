...
jupyter nbconvert --to notebook --execute example_scripts/notebook_tutorials/runnable_notebooks/${directory}/*.ipynb --allow-errors --log-level=DEBUG  --ExecutePreprocessor.timeout=600 --output-dir example_scripts/notebook_tutorials/runnable_notebooks/executed/${directory}/
