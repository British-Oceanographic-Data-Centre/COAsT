...
class Transect:
    ...
    def export_netcdf(self, ofile:str=None, var_str:str=None, format="NETCDF4"):
        ...
        Example usages (for e.g. TRANSECT object: tran_f):
        tran_f.export_netcdf( var_str = 'bathymetry' )
        tran_f.export_netcdf( 'tmp.cdf', var_str = 'bathymetry' )
        tran_f.export_netcdf( 'tmp.cdf', var_str='bathymetry', format='NETCDF3_CLASSIC' )
        """
        if ofile == None:
