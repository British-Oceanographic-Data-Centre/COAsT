...
class ContourF(Contour):
    ...
    def calc_geostrophic_flow(self, nemo_t: Coast, ref_density=None):
        ...
        cont_t = ContourT(nemo_t_local, self.y_ind, self.x_ind, self.depth)  # j,i
        cont_t_j1 = ContourT(nemo_t_local, self.y_ind + 1, self.x_ind, self.depth)  # j+1,i
        cont_t_i1 = ContourT(nemo_t_local, self.y_ind, self.x_ind + 1, self.depth)  # j,i+1
        cont_t_j1i1 = ContourT(nemo_t_local, self.y_ind + 1, self.x_ind + 1, self.depth)  # j+1,i+1
