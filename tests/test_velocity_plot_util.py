...
def test_velocity_grid_to_geo():
    ...
    u_new, v_new = plot_util.velocity_grid_to_geo(
        lon, lat, u_velocity, v_velocity, polar_stereo=False)
    u_result1 = np.array(([1.04903051, 1.05046004, 1.05188719], [
        1.04144945, 1.04295465, 1.04445727], [
        1.03380243, 1.03538430, 1.03696338]))
    v_result1 = np.array(([0.94843818, 0.94685463, 0.94526893], [
    ...
    v_result2 = np.array(([0.71058865, 0.73039665, 0.74888326], [
