...
class test_profile_methods(unittest.TestCase):
    ...
    def test_compare_processed_profile_with_model(self):
        ...
        with self.subTest("Regional Averaging"):
            ...
            check3 = mask_indices.dims["dim_mask"] == mask_stats_model.dims["dim_mask"]  # since profiles are in mask regions
            check4 = np.isclose(mask_stats_model.all_mean_diff_temperature.values[0], -0.8169331445866469)  # includes mean and std
