...
fig = plt.figure()
plt.pcolormesh(sci_t_box.dataset.longitude, sci_t_box.dataset.latitude, sci_t_box.dataset.salinity.isel(t_dim=0).isel(z_dim=lp))
plt.clim(30,35)
plt.colorbar()
...
#child salinity 
fig = plt.figure()
plt.pcolormesh(child_sci_t.dataset.longitude, child_sci_t.dataset.latitude, child_sci_t.dataset.salinity.isel(t_dim=ti).isel(z_dim=li))
plt.colorbar()
plt.clim(30,35)
plt.xlabel("longitude")
plt.ylabel("latitude")
...
# differences plot 
fig = plt.figure()
plt.pcolormesh(child_sci_t.dataset.longitude, child_sci_t.dataset.latitude, child_sci_t.dataset.salinity.isel(t_dim=ti).isel(z_dim=li)-varinterp[:,:,li])
plt.clim(-1,1)
plt.colorbar()
plt.xlabel("longitude")
plt.ylabel("latitude")
