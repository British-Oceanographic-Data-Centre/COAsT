...
print(lon)
ind = cst.general_utils.subset_indices_lonlat_box(lon, lat, ss=15, ww=20, ee=25)
print("Here's the subset for [20,25] - note omission of 25")
print(lon[ind])
print("Interchange east and west")
ind = cst.general_utils.subset_indices_lonlat_box(lon, lat, ss=15, ww=25, ee=20)
print(lon[ind])
print("Use negative longitude")
ind = cst.general_utils.subset_indices_lonlat_box(lon, lat, ss=15, ww=-340, ee=25)
print(lon[ind])
