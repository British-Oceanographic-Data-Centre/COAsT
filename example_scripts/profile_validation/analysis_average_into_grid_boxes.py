...
# List of input files
fn_in_list = ["<PATH_TO_NETCDF_PROFILE_OBJECT_1>",
              "<PATH_TO_NETCDF_PROFILE_OBJECT_2>",
              "..."]
...
fn_out_list = ["<OUTPUT_FILENAME_1.nc>",
               "<OUTPUT_FILENAME_2.nc>", 
               "..."]
...
for ff in range(number_of_files):
    ...
    prof_gridded_DJF = profile_analysis.average_into_grid_boxes(grid_lon, grid_lat, 
                                                         season="DJF", var_modifier="_DJF")
    prof_gridded_MAM = profile_analysis.average_into_grid_boxes(grid_lon, grid_lat, 
                                                         season="MAM", var_modifier="_MAM")
    prof_gridded_JJA = profile_analysis.average_into_grid_boxes(grid_lon, grid_lat, 
                                                         season="JJA", var_modifier="_JJA")
    prof_gridded_SON = profile_analysis.average_into_grid_boxes(grid_lon, grid_lat, 
                                                         season="SON", var_modifier="_SON")
