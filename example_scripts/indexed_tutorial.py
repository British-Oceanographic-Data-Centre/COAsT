...
altimetry = coast.Altimetry(
    file_path="./example_files/COAsT_example_altimetry_data.nc", config="./config/example_altimetry.json"
)
...
oceanparcels = coast.Oceanparcels(
    file_path=dir + "OceanParcels_GFDL-ESM2M.2043r3.1.nc", config="./config/example_oceanparcels.json"
)
...
tidegauge = coast.Tidegauge(
    file_path="./example_files/tide_gauges/lowestoft-p024-uk-bodc",
    date_start=date0,
    date_end=date1,
    config="./config/example_tidegauge.json",
)
