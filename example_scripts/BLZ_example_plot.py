...
sci_t = coast.NEMO(dir_nam + fil_nam, dom_nam, grid_ref="t-grid", multiple=False)

sci_u = coast.NEMO(dir_nam + fil_nam.replace("grid_T", "grid_U"), dom_nam, grid_ref="u-grid", multiple=False)
